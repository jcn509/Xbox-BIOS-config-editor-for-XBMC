...
class IndBiosConfigEditor(AbstractConfigEditor):
    def _create_tab_data(self):
        tabs_dict = OrderedDict([
            ("Basic", {
                "tab": tabs.ind_bios.Basic,
                "icon": "settings.png"
            }),
            ("Boot Settings", {
                "tab": tabs.ind_bios.BootSettings,
                "icon": "dashboard.png"
            }),
            ("Flubber", {
                "tab": tabs.ind_bios.Flubber,
                "icon": "video_camera_round.png"
            }),
            ("X Screen", {
                "tab": tabs.ind_bios.XScreen,
                "icon": "close.png"
            }),
            ("Advanced", {
                "tab": tabs.ind_bios.Advanced,
                "icon": "option_bar_settings.png"
            })
        ])
        tab_data = {
            "tabs": tabs_dict,
