...
from .config_validators import BooleanValidator, IntegerValidator, DiscreteValidator, RegexMatchPatternValidator, ColourWithAlphaValidator, ColourValidator, DVDFilePathValidator, HDDFilePathValidator, OptionalHDDFilePathValidator
...
def validator_factory(config_field):
    if isinstance(config_field, BooleanField):
        ...
        return _COLOUR_WITH_ALPHA_VALIDATOR if config_field.with_alpha_channel else _COLOUR_VALIDATOR
    else:
