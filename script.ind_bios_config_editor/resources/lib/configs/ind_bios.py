...
class IndBiosConfig(AbstractConfig):
    ...
    def _get_true_if_fields_dont_have_values(self):
        ...
        return {
            "FOG1CUSTOM": {"FOG1COLOR": IND_BIOS_FIELDS.fog1color.default_value},
            "FOG1CUSTOM": {"FOG2COLOR": IND_BIOS_FIELDS.fog2color.default_value},
            "SKEWEN": {"XSKEWLOGO": 0, "YSKEWLOGO": 0},
        }
