...
class XScreen(AbstractIndBiosTab):
    ...
    def _create_controls(self):
        ...
        self._place_and_link(
            "BGCOLOR",
            controls.ColourPicker("Background colour"),
            0, 3
        )
        self._place_and_link(
            "NOLIGHTEN",
        ...
        self._place_and_link(
            "XGLOWCOLOR",
            controls.ColourPicker("'X' glow colour"),
            1, 2
        )
        self._place_label("'X' inner colour", 1, 3)
        self._place_and_link(
            "XINNERCOLOR",
            controls.ColourPicker("'X' inner colour of 'X'"),
            1, 4
        )
        self._place_and_link(
            "TMS",
            controls.RadioButton("Show TMs"),
            1, 5
        )
        ...
        self._place_and_link(
            "LIPCOLOR",
            controls.ColourPicker("Lip color"),
            2, 1            
        )
        self._place_label("Lip glow", 2, 2)
        self._place_and_link(
            "LIPGLOW",
            controls.ColourPicker("Lip glow"),
            2, 3
        )
        self._place_label("'X' light colour", 2, 4)
        self._place_and_link(
            "XLIGHTCOLOR",
            controls.ColourPicker("Color of the light on upper right of 'X'", alpha_selector = True),
            2, 5
        )
        ...
        self._place_and_link(
            "XSKEWXLOGO",
            controls.FakeSlider(min_value = -100, max_value = 100, picker_title = "'X' logo X change"),
            3, 1,
            columnspan = 2
        )
        ...
        self._place_and_link(
            "YSKEWXLOGO",
            controls.FakeSlider(min_value = -100, max_value = 100, picker_title = "'X' logo Y change"),
            3, 4,
            columnspan = 2
        )
        ...
        self._place_and_link(
            "IND3D",
            controls.RadioButton("iND 'XBOX' text"),
            5, 0
        )
        self._place_label("'XBOX' text colour", 5, 1)
        self._place_and_link(
            "XBOXCOLOR",
            controls.ColourPicker("'XBOX' text colour"),
            5, 2
        )
        ...
        self._place_and_link(
            "SHOWMSEN",
            controls.RadioButton("Show 'MS' logo"),
            7, 0
        )
        self._place_and_link(
            "MSLOGOTRANSEN",
        ...
        self._place_and_link(
            "MSLOGOTRANSCOLOR",
            controls.ColourPicker("Transperancy colour"),
            7, 4
        )
        self._place_label("'MS' logo X change", 8, 0)
        self._place_and_link(
            "XSKEWLOGO",
            controls.FakeSlider(min_value = -100, max_value = 100, picker_title = "'MS' logo X change"),
            8, 1,
            columnspan = 2
        )
        ...
        self._place_and_link(
            "YSKEWLOGO",
            controls.FakeSlider(min_value = -100, max_value = 100, picker_title = "'MS' logo Y change"),
            8, 4,
            columnspan = 2
        )
        ...
        self._place_and_link(
            "CUSTOMLOGO",
            controls.FileSelectorOrZero(heading = "Custom 'MS' logo", mask = ".bmp", use_thumbs = True),
            9, 1,
            columnspan = 5
        )
